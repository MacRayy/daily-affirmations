...
import { NICHE_AFFIRMATIONS, getNicheAffirmationOfTheDay, NICHE_SLUGS } from '@/app/data/niche-affirmations'
...
export default async function NicheAffirmationPage({ params }: { params: Promise<{ topic: string }> }) {
  const { topic } = await params
  const nicheData = NICHE_AFFIRMATIONS[topic]
        ...
        <main className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="mt-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {NICHE_SLUGS.filter(slug => slug !== topic).slice(0, 6).map(slug => {
          ...
          <div className="mt-12 bg-white rounded-2xl border-2 border-gray-200 shadow-lg p-8">
            ...
            <div className="text-gray-600 leading-relaxed space-y-4">
              <p>
                These affirmations for {topic.replace(/-/g, ' ')} are designed to help you build a positive mindset
                and overcome challenges in this specific area of your life. Regular practice can lead to
                meaningful changes in how you think and feel.
              </p>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>Use the &ldquo;Generate New&rdquo; button to find affirmations that resonate with you</li>
