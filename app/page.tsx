          ...
          <div className="mt-12">
            <div className="bg-white rounded-2xl border-2 border-gray-200 shadow-lg p-8">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Transform your mindset with personalized daily affirmations. Our affirmation
                generator provides unique, meaningful affirmations tailored to your specific
                needs—whether you&#39;re focusing on career success, building confidence, nurturing
                relationships, or prioritizing your health and wellbeing.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Research shows that daily positive affirmations can reduce stress, increase
                self-confidence, and improve overall mental wellbeing. Start each morning with a
                fresh affirmation designed to inspire and empower you throughout your day.
              </p>
            </div>
          </div>
        </main>
